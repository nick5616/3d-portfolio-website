...
const createArtLayout = (): InteractiveElement[] => [
  ...
  ...[-7, -2.5, 2.5, 7].map(
    (xOffset, i): InteractiveElement => ({
      id: `art-back-${i}`,
      type: "model",
      position: [xOffset, 2 + (i % 2) * 0.8, -9] as [number, number, number],
    ...
    lightPreset: {
      ...
      spots: [
        ...
        ...Array(6)
          .fill(0)
          .map((_, i) => ({
            position: [-8, 6, -7 + i * 3] as [number, number, number],
        ...
        ...Array(6)
          .fill(0)
          .map((_, i) => ({
            position: [-7 + i * 3, 6, -8] as [number, number, number],
  ...
  about: {
    ...
    interactiveElements: [
      ...
      },
      {
        ...
        content: "Contact: email@example.com\nGitHub: github.com/username",
      },
      // Decorative pillars
      ...Array(4)
        .fill(0)
        .map(
          (_, i): InteractiveElement => ({
            id: `about-pillar-${i}`,
            type: "model",
            position: [3 + (i % 2) * 4, 0, -3 + Math.floor(i / 2) * 6] as [
              number,
              number,
              number
            ],
